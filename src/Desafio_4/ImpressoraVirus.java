...
Depois de olhar para várias páginas impressas por um tempo, você percebe que ele está imprimindo cada linha
de dentro para fora.
Em outras palavras, a metade esquerda de cada linha está sendo impressa a partir do meio da página até a
margem esquerda. Do mesmo modo, a metade direita de cada linha está sendo impressa à partir da margem direita
...
Da mesma forma, a linha " MANGOS " está sendo impressa incorretamente como "NAM SOG".
...
Seguem N linhas, cada uma com uma frase com no mínimo 2 e no máximo 100 caracteres de letras maiúsculas e espaços que deverá ser desembaralhada (decifrada) à partir da
...
H YPPAHSYADILO ABCDEFGHIJKLMNOPQRSTUVWXYZ
VOD OWT SNEH HCNERF EGDIRTRAP A DNA SE

 Exemplo de Saída
THIS LINE IS GIBBERISH LEVELKAYAK
HAPPY HOLIDAYS MLKJIHGFEDCBAZYXWVUTSRQPON
